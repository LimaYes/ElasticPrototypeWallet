    ...
    private static Primitives.NODE_TYPE get_node_type(Primitives.STATE state, Primitives.SOURCE_TOKEN token, int token_num) {
        ...
        switch (token.type) {
            ...
            case TOKEN_ADD_ASSIGN:
                node_type = NODE_ADD_ASSIGN;
                break;
            case TOKEN_SUB_ASSIGN:
                node_type = NODE_SUB_ASSIGN;
                break;
            case TOKEN_MUL_ASSIGN:
                node_type = NODE_MUL_ASSIGN;
                break;
            case TOKEN_DIV_ASSIGN:
                node_type = NODE_DIV_ASSIGN;
                break;
            case TOKEN_MOD_ASSIGN:
                node_type = NODE_MOD_ASSIGN;
                break;
            case TOKEN_LSHFT_ASSIGN:
                node_type = NODE_LSHFT_ASSIGN;
                break;
            case TOKEN_RSHFT_ASSIGN:
                node_type = NODE_RSHFT_ASSIGN;
                break;
            case TOKEN_AND_ASSIGN:
                node_type = NODE_AND_ASSIGN;
                break;
            case TOKEN_XOR_ASSIGN:
                node_type = NODE_XOR_ASSIGN;
                break;
            case TOKEN_OR_ASSIGN:
                node_type = NODE_OR_ASSIGN;
                break;
            case TOKEN_ADD:
                node_type = NODE_ADD;
                break;
            ...
            case TOKEN_LROT:
                ...
                break;
            case TOKEN_LSHIFT:
                node_type = NODE_LSHIFT;
                break;
            case TOKEN_RROT:
                node_type = NODE_RROT;
                break;
            case TOKEN_RSHIFT:
                node_type = NODE_RSHIFT;
                break;
            case TOKEN_LE:
                node_type = NODE_LE;
                break;
            ...
            case TOKEN_BITWISE_AND:
                node_type = NODE_BITWISE_AND;
                break;
            case TOKEN_BITWISE_XOR:
                node_type = NODE_BITWISE_XOR;
                break;
            case TOKEN_BITWISE_OR:
                node_type = NODE_BITWISE_OR;
                break;
            case TOKEN_AND:
                node_type = NODE_AND;
                break;
            ...
            case TOKEN_CONDITIONAL:
                node_type = NODE_CONDITIONAL;
                break;
            case TOKEN_COND_ELSE:
                node_type = NODE_COND_ELSE;
                break;
            case TOKEN_IF:
                node_type = NODE_IF;
                break;
            case TOKEN_ELSE:
                ...
                break;
            case TOKEN_REPEAT:
                node_type = NODE_REPEAT;
                break;
            case TOKEN_BREAK:
                node_type = NODE_BREAK;
                break;
            case TOKEN_CONTINUE:
            ...
            case TOKEN_ATAN:
                ...
                break;
            case TOKEN_ATAN2:
                node_type = NODE_ATAN2;
                break;
            case TOKEN_EXPNT:
                node_type = NODE_EXPNT;
                break;
            case TOKEN_LOG:
                node_type = NODE_LOG;
                break;
            case TOKEN_LOG10:
                node_type = NODE_LOG10;
                break;
            case TOKEN_POW:
                node_type = NODE_POW;
                break;
            ...
            case TOKEN_ARRAY_INT:
                node_type = NODE_ARRAY_INT;
                break;
            case TOKEN_ARRAY_UINT:
                node_type = NODE_ARRAY_UINT;
                break;
            case TOKEN_ARRAY_LONG:
                node_type = NODE_ARRAY_LONG;
                break;
            case TOKEN_ARRAY_ULONG:
                node_type = NODE_ARRAY_ULONG;
                break;
            case TOKEN_ARRAY_FLOAT:
                node_type = NODE_ARRAY_FLOAT;
                break;
            case TOKEN_ARRAY_DOUBLE:
                node_type = NODE_ARRAY_DOUBLE;
                break;
            case TOKEN_SUBMIT_SZ:
                node_type = NODE_SUBMIT_SZ;
                break;
            case TOKEN_SUBMIT_IDX:
                node_type = NODE_SUBMIT_IDX;
                break;
            case TOKEN_FUNCTION:
                node_type = NODE_FUNCTION;
                break;
            case TOKEN_CALL_FUNCTION:
                node_type = NODE_CALL_FUNCTION;
                break;
            case TOKEN_VERIFY_BTY:
                node_type = NODE_VERIFY_BTY;
                break;
            case TOKEN_VERIFY_POW:
                node_type = NODE_VERIFY_POW;
                break;
            default:
                return NODE_ERROR;
        }
        ...
        for (i = 0; i < state.token_list.size(); i++) {
            ...
            switch (state.token_list.get(i).type) {
                ...
                case TOKEN_BLOCK_END:
                    ...
                    while ((state.stack_exp.size() > 1) && state.stack_exp.get(state.stack_exp.size() - 2).token_num > top_op(state) && top_exp(state).token_num < i) { // state.stack_exp.get(state.stack_exp.size() - 1) instead of topexp?
                        create_exp(state, state.token_list.get(i), top_op(state));
                        top_exp(state).end_stmnt = true;
                    }
                    pop_op(state);
