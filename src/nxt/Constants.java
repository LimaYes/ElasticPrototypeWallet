...
public final class Constants {
    ...
    public static final long[] FOUNDATION_MEMBER_IDS = {3977330746712865438L, -1255995780042666937L, -7945280390087411431L};
    ...
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Nxt.getIntProperty("nxt.testnetGuaranteedBalanceConfirmations", 1440) : 33;
    ...
    public static final int[] MIN_VERSION = new int[] {3, 0, 0};
    public static final int[] MIN_PROXY_VERSION = new int[] {3, 0, 0};
