...
abstract class CreateTransaction extends APIServlet.APIRequestHandler {
    ...
    final JSONStreamAware createTransaction(HttpServletRequest req, Account senderAccount, long recipientId,
        ...
        // Make sure redeem has a public key announcement
        if (publicKeyAnnouncement==null && secretPhrase!=null && attachment instanceof Attachment.RedeemAttachment){
            // Add public key announcement from secretPhrase (we can only redeem to our local account and it is good to have the public key revealed within this transaction in all cases)
            Appendix.PublicKeyAnnouncement ann = new Appendix.PublicKeyAnnouncement(Crypto.getPublicKey(secretPhrase));
            publicKeyAnnouncement = ann;
        }
        ...
        // Also: Special Treatment of REDEEM
        byte[] publicKey;
        ...
        try {
            ...
            // Also here, special building of REDEEM TX
