...
public class WorkTest {
    ...
    public void newWorkTest(){
        ...
        Appendix.PrunablePlainMessage message = MessageEncoder.encodeAttachment(work);

        ByteBuffer b = ByteBuffer.allocate(1000000);
        work.putMyBytes(b);
        System.out.println("[bb]\t" + b.toString());
        System.out.println("[in]\t" + work.toString());
        System.out.println("[what]\t" + message.getJSONObject().toJSONString());
        IComputationAttachment out = MessageEncoder.decodeAttachment(message);
