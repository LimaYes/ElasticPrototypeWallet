...
var c_cppHighlightRules = function() {
    ...
    var keywordControls = (
        "function|break|repeat|continue|if|else"
    );
    ...
    var storageModifiers = (
        "array_int|array_uint|array_long|array_ulong|array_float|array_double|submit_sz|submit_idx"
    );

    var keywordOperators = (
                "sinh|sin|cosh|cos|tanh|tan|asin|acos|atan|atan2|exp|log10|log|pow|sqrt|ceil|floor|fabs|abs|fmod|gcd|verify_bty|verify_pow"
    ...
    var keywordMapper = this.$keywords = this.createKeywordMapper({
        ...
        "constant.other" : keywordOperators,
        "variable.language": "this",
        "constant.language": builtinConstants
    }, "identifier");

    var identifierRe = "[a-z]+\[[0-9]+\]";
